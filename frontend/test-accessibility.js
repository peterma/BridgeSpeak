...
const colorTests = [
  ...
  },
  {
    ...
    background: '#0F7A6B', // --primary-blue (updated)
    minContrast: 4.5
  },
  {
    name: 'Accent green on white background',
    foreground: '#2D8B47', // --accent-green (updated)
    background: '#FFFFFF', // --bg-card
    minContrast: 3.0
  },
  {
    name: 'Secondary yellow on white background',
    foreground: '#B8860B', // --secondary-yellow (updated)
    background: '#FFFFFF', // --bg-card
    minContrast: 3.0
  },
  {
    name: 'Primary blue light on dark background',
    foreground: '#4ECDC4', // --primary-blue-light
    background: '#2D3748', // --text-primary (as background)
    minContrast: 3.0
  }
];
